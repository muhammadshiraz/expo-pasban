...
const DashboardMenuScreen = ({ navigation }) => {
  ...
  const vdBoxData = [
    {
      id: '1',
      title: 'Go to Violation Dashboard',
      screen: 'Violation',
      icon: () => <Icon name="vehicle_car" size={35} />,
    },
  ];
  ...
  const ltoBoxData = [
    {
      id: '1',
      title: 'Go to LTO / DDC / DL Dashboard',
      screen: 'LTO',
      icon: () => <Icon name="lto_ddc" size={35} />,
    },
  ];
  ...
  return (
    <Layout type="submenu" title="Dashboards">
