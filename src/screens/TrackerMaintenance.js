...
const TrackerMaintenance = ({ navigation }) => {
  ...
  const vdBoxData = [
    {
      ...
      screen: 'CreateTrackerRemovalRequest',
      icon: () => <Icon name="create_new_request" size={35} />,
    },
  ];
  ...
  const ltoBoxData = [
    {
      ...
      screen: 'ViewAllTrackerRemovalRequest',
      icon: () => <Icon name="view_all_request" size={40} />,
    },
  ];
  ...
  return (
    <Layout type="submenu" title="Tracker Maintenance">
...
export default TrackerMaintenance;
