...
const ManageQuiz = () => {
  const columns = [
    { label: 'ID', width: 50 },
    { label: 'Quiz Name', width: 80 },
    { label: 'Test Type', width: 100 },
    { label: 'Driving License Info Required', width: 450 },
    { label: 'Remarks', width: 50 },
    { label: 'Date', width: 450 },
  ...
  const rows = [
    {
      ID: '43',
      'Quiz Name': 'DDC Quetta/KHI',
      'Test Type': 'DDC',
      'Driving License Info Required': 'Yes',
      Remarks: 'none',
      Date: 'May 14, 2024 at 2:43:09 PM',
      Action: (
        <View style={styles.actionIcons}>
          <Icon name="edit" size={16} color="#6c6" style={styles.icon} />
          <Icon name="plus" size={16} color="#66f" style={styles.icon} />
          <Icon name="trash" size={16} color="#f66" style={styles.icon} />
        </View>
      ),
    },
    {
